    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
      <div class="grid md:grid-cols-3 gap-8">
        <div
          v-for="plan in plans"
          :key="plan.id"
          class="relative rounded-2xl bg-white border-2 p-8"
          :class="plan.popular ? 'border-primary-500 shadow-xl' : 'border-gray-200'"
        >
          <!-- Popular Badge -->
          <span
            v-if="plan.popular"
          ...
          <div class="mt-4 mb-6">
            ...
            <span v-if="plan.price[billingPeriod] > 0" class="text-gray-500">
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b border-gray-200">
                <th class="py-4 px-6 text-left text-sm font-medium text-gray-500">Feature</th>
                <th class="py-4 px-6 text-center text-sm font-medium text-gray-900">Free</th>
                <th class="py-4 px-6 text-center text-sm font-medium text-primary-600">Enterprise</th>
                <th class="py-4 px-6 text-center text-sm font-medium text-gray-900">Exclusive</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">Projects</td>
                <td class="py-4 px-6 text-center text-sm text-gray-900">2</td>
                <td class="py-4 px-6 text-center text-sm text-gray-900">10</td>
                <td class="py-4 px-6 text-center text-sm text-gray-900">Unlimited</td>
              </tr>
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">Animation Editor</td>
              ...
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">Custom CSS</td>
                <td class="py-4 px-6 text-center">
                  <svg class="w-5 h-5 text-gray-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg>
              ...
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">One-Click Publish</td>
                <td class="py-4 px-6 text-center">
                  <svg class="w-5 h-5 text-gray-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg>
              ...
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">Custom Domain</td>
                <td class="py-4 px-6 text-center">
                  <svg class="w-5 h-5 text-gray-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg>
              ...
              <tr>
                <td class="py-4 px-6 text-sm text-gray-600">Analytics Dashboard</td>
                <td class="py-4 px-6 text-center">
                  <svg class="w-5 h-5 text-gray-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                  </svg>
